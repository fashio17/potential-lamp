...
1. **1カット目に「人が街に立っている・歩いている絵」を置かない。**
   置くのは**服の寄り**。ラック、クローゼット、たたんだ服、足元。1秒で「服の話」と分かる絵。
2. **表紙の1行目に地名を置かない。**
   「パリの街は」で始めた瞬間に旅行の動画になります。
   当たった2本はどちらも日本の日常から入っています
   （旅行にパンツを持っていくの、やめました／この暑いのに、なぜ黒を着るのですか）。
3. **2カット目に観光の名所を置かない。** 1カット目で持ちこたえても、ここで確定します。
4. **テロップは2行まで。** 3行は2.07秒では読めません（R4でも同じことが起きています）。

**R4のときに「サムネが観光写真で服の話に見えない」と書いておきながら、
R1で同じことをしました。** 次に作るときは、この節を読んでから1カット目を決めること。
