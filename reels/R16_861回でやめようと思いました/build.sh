...
NY="/home/user/potential-lamp/reels/素材/ニューヨーク"
...
EM="$NY/IMG_1963_夜景_エンパイアステートビル.mov" # 3.8秒。人なし・文字なし。全域使える
RK="$NY/IMG_2026_売り場のラック_生成りと白.mov"  # 6.8秒。人なし・文字なし。全域使える
...
# 【2026/9/15 差し替え】もとは2・3ともヴェルサイユ（IMG_1079）だったが、
#   **IMG_1079 は9/2投稿のR4で使用済み**だった（素材台帳の品目表が「未使用」のまま
#   古くなっていた。使用済み一覧のほうが正しい）。使い回しになるので差し替えた。
# 2 夜のニューヨーク。エンパイアステートビル。人なし・文字なし
cutc  "$EM" 0.60 1.28 "1080:1920:0:0"         $SP/segR16/k2.mp4
# 3 売り場のラック。生成り・白・こげ茶。人なし・文字なし
cutc  "$RK" 3.60 1.28 "1080:1920:0:0"         $SP/segR16/k3.mp4
