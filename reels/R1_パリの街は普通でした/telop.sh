...
CH="$(dy 1  0.10  2.00 58 380),\
$(d  2  2.17  4.07 54),\
$(dy 3  4.24  6.14 64 380),\
$(dy 4  6.31  8.21 62 380),\
$(dy 5  8.38 10.28 52 520),\
$(d  6 10.45 12.35 64),\
$(dy 7 12.52 14.42 62 560),\
$(dy 8 14.59 16.49 56 380),\
$(dy 9 16.66 18.56 66 380)"
