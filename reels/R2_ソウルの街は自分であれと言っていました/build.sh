...
# 同じ写真からでも、被写体が変わるように場所を離して切る（シャツ／かご／パンツ）
pkc $R "900:1600:2850:600"  $SP/segR2/k1.mp4 1.00 1.06   # 白と水色のシャツ（表紙）
pkc $R "850:1511:300:900"   $SP/segR2/k2.mp4 1.06 1.00   # かごバッグ
cut "$P/IMG_7292_店内_他人の顔あり.mov" 0.30 "1620:2880:270:0" $SP/segR2/k3.mp4   # 店内・シャンデリア
...
pkc $R "950:1689:1100:900"  $SP/segR2/k6.mp4 1.00 1.06   # こげ茶のワイドパンツ
pkc $T "1300:2311:2500:1200" $SP/segR2/k7.mp4 1.06 1.00  # 本人・ソウルの店の前
cut "$P/IMG_0839_街の外観_下に歩行者多数.mov" 0.90 "2160:3840:0:0" $SP/segR2/k8.mp4  # パリの百貨店の外観
cut "$P/IMG_7292_店内_他人の顔あり.mov" 2.10 "1620:2880:270:0" $SP/segR2/k9.mp4   # 店内（締め）
